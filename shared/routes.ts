...
import {
  products, opnameSessions, opnameRecords, userRoles, inboundItems, outboundItems,
  insertProductSchema, insertSessionSchema, insertInboundSessionSchema, insertInboundItemSchema,
  insertOutboundSessionSchema, insertOutboundItemSchema, insertBomSchema, insertBomItemSchema,
  insertAssemblySessionSchema, insertCustomerSchema, insertSaleSchema, insertSaleItemSchema,
  boms, bomItems, assemblySessions, insertUserRoleSchema, insertProductPhotoSchema, insertProductUnitSchema,
  insertPosDeviceSchema, insertTieredPricingSchema, insertProductBundleSchema,
  insertCategorySchema, insertUnitSchema
} from './schema';
...
export const api = {
  ...
  inbound: {
    ...
    addItem: {
      ...
      input: createInsertSchema(inboundItems).omit({ id: true, sessionId: true }),
    },
    removeItem: {
      method: 'DELETE' as const,
  ...
  outbound: {
    ...
    addItem: {
      ...
      input: createInsertSchema(outboundItems).omit({ id: true, sessionId: true }),
    },
    removeItem: {
      method: 'DELETE' as const,
